...
<html lang="en">
  ...
  <body>
    <main class="container">
        <h1>Modelos</h1>
        <a href="/modelo/inserir" class="btn btn-primary">Novo Modelo</a>
        <p><?= $mensagem ?></p>
                ...
                <?php
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?=  $c['marca']?></td>
                            <td>
                                <a href="/modelo/alterar/id/<?= $c["id"]?>" class="btn btn-warning">
                                    Alterar
                                </a> 
                                <a href="/modelo/excluir/id/<?= $c["id"]?>" class="btn btn-danger">
                                    Excluir
                                </a> 
                            </td>
                        </tr>
