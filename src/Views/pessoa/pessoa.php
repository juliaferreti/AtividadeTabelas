...
<html lang="en">
  ...
  <body>
    <main class="container">
        <h1>Pessoas</h1>
        <a href="/pessoa/inserir" class="btn btn-primary">Nova Pessoa</a>
        <p><?= $mensagem ?></p>
                ...
                <?php
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?=  $c['telefone']?></td>
                            <td>
                                <a href="/pessoa/alterar/id/<?= $c["id"]?>" class="btn btn-warning">
                                    Alterar
                                </a> 
                                <a href="/pessoa/excluir/id/<?= $c["id"]?>" class="btn btn-danger">
                                    Excluir
                                </a> 
                            </td>
                        </tr>
