...
<html lang="en">
  ...
  <body>
    <main class="container">
        <h1>Decorações</h1>
        <a href="/decoracao/inserir" class="btn btn-primary">Nova Decoração</a>
        <p><?= $mensagem ?></p>
                ...
                <?php
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?=  $c['fruta']?></td>
                            <td>
                                <a href="/decoracao/alterar/id/<?= $c["id"]?>" class="btn btn-warning">
                                    Alterar
                                </a> 
                                <a href="/decoracao/excluir/id/<?= $c["id"]?>" class="btn btn-danger">
                                    Excluir
                                </a> 
                            </td>
                        </tr>
