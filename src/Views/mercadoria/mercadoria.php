...
<html lang="en">
  ...
  <body>
    <main class="container">
        <h1>Mercadorias</h1>
        <a href="/mercadoria/inserir" class="btn btn-primary">Nova Mercadoria</a>
        <p><?= $mensagem ?></p>
                ...
                <?php
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?=  $c['validade']?></td>
                            <td>
                                <a href="/mercadoria/alterar/id/<?= $c["id"]?>" class="btn btn-warning">
                                    Alterar
                                </a> 
                                <a href="/mercadoria/excluir/id/<?= $c["id"]?>" class="btn btn-danger">
                                    Excluir
                                </a> 
                            </td>
                        </tr>
